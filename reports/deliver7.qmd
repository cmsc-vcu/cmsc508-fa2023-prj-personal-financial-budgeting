...
2) A bulleted list of:
    ...
    * URL to your design video (Task 12): <https://vcu.zoom.us/rec/share/oCleWmpGURaTP66RLhkGcvkRuolHAeBSUXy7Iw0Mw0ZqyXja9pi2Ifq444VIk0V0.z9Rcgx_cklmfOsti>
...
* Screenshots: Include screenshots of the API requests and responses, especially if using a graphical tool like Postman.
* Code Blocks: Use code blocks to clearly present curl commands or Python requests code snippets.
* Narrative: Add explanatory text before each code snippet to guide the reader through what each step is doing.
* Formatting: Use Quarto's formatting capabilities to make the document easy to read and navigate.
* Error Handling: Demonstrate common errors and how the API handles them, including screenshots or code snippets of both the request and the API's response.
...
Here is a link to the part of the GitHub which contains the DDL: <https://github.com/cmsc-vcu/cmsc508-fa2023-prj-personal-financial-budgeting/blob/main/reports/deliver7-ddl.sql>

## 16) Future considerations
What needs to be done next to take your project to the next level? If you had more time, what would you do next?

If we had more time, the most usefull thing to add for users of this database would most likely be some form of front ent UI to make it easier for people to see their budgets/finances. Another thing to add might be an automatic way to view income and spending trends to help users plan for their future finances easier.
